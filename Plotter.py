...
def plot_wav_samples(samples: List[int] | str | Wave_read, alpha=1, sample_rate=10000, color="tab:blue"):
    ...
    y = [sample / 2**16 for sample in samples]
...
def plot_line(ms):
    ...
    plt.axvline(ms / 1000, color="r", alpha=1)
    # x += notes[i]["duration"]
